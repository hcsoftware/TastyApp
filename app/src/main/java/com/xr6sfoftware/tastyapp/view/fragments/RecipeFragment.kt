...
import com.xr6sfoftware.tastyapp.viewmodel.RecipeViewModel
...
class RecipeFragment : Fragment() {
    ...
    private fun loadRecipeOnViews(recipeDetail: RecipeDetail) {
        ...
        viewBinding.recipeFragmentImage.load(recipeDetail.thumbnail_url)
        ...
        viewBinding.recipeFragmentPrepTime.text =
            if (recipeDetail.prep_time_minutes == 0) {resources.getString(R.string.recipe_frag_prep_time) + resources.getString(R.string.recipe_frag_no_data) }
            else {resources.getString(R.string.recipe_frag_prep_time) + recipeDetail.prep_time_minutes.toString()}
        viewBinding.recipeFragmentTotalTime.text =
            if (recipeDetail.total_time_minutes == 0) {resources.getString(R.string.recipe_frag_total_time) + resources.getString(R.string.recipe_frag_no_data) }
            else {resources.getString(R.string.recipe_frag_total_time) + recipeDetail.total_time_minutes.toString()}
